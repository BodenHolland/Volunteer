      ...
      <main id="main" className="flex-1">
        <section className="border-b border-line bg-section">
          <div className="mx-auto max-w-[1200px] px-4 py-12 md:px-6 md:py-16">
            ...
            <p className="mt-4 max-w-[680px] text-lg leading-relaxed text-body">
            ...
            <div className="service-panel mt-6 flex max-w-[760px] items-start gap-3 border-amber/40 bg-amber-subtle p-5">
              <AlertCircle
