  ...
  if (locale === "es") {
    ...
    return (
      <ArticleShell number={10} title="Quién certifica tus horas, y cómo" prev={prevEs} next={nextEs}>
        <p>En el CF 888 de California, el New York Monthly ABAWD Volunteer Participation Record y los formularios estatales equivalentes, la firma en la sección de la organización es lo que hace que el formulario sea válido. Aquí está quién firma, qué certifica y qué exige la ley.</p>
        ...
        <p>El CF 888 verificado (rev. 5/25), Sección 2:</p>
        <blockquote>
        ...
        <ul>
          ...
          <li>No hay campo de EIN. Un EIN puede aparecer en un certificado de participante por separado que Tended emite junto con el formulario, pero el documento operativo es el CF 888.</li>
        </ul>
        ...
        <p>La función de certificación está separada por política de las métricas de recaudación de fondos y de crecimiento. El papel del representante no se mide por cuántos CF 888 firma ni por cuántos beneficiarios están inscritos. (Consulta Quién financia Tended para conocer los detalles del cortafuegos de financiación.)</p>
        ...
        <hr />
        <p><em>No es asesoría legal. Referencia: <a href="https://cdss.ca.gov/Portals/9/Additional-Resources/Forms-and-Brochures/2020/A-D/CF888.pdf" target="_blank" rel="noopener noreferrer">CF 888 (CDSS)</a>.</em></p>
      </ArticleShell>
    );
  }
