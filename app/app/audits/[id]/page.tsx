...
const COPY = {
  en: {
    ...
    client: {
      ...
      searchLabel: "Can't find it nearby? Search by name or address",
      ...
      commuteUnknownPre: "We can't estimate your commute yet — add your home address on your ",
      commuteUnknownLink: "SNAP profile",
      commuteUnknownPost: " to credit your travel time.",
  ...
  es: {
    ...
    client: {
      ...
      searchLabel: "¿No la ves cerca? Busca por nombre o dirección",
      ...
      commuteUnknownPre: "Aún no podemos estimar tu trayecto — agrega tu dirección en tu ",
      commuteUnknownLink: "perfil de SNAP",
      commuteUnknownPost: " para acreditar tu tiempo de viaje.",
