...
export const metadata = { title: "Terms of Service — Tended" };
...
function En() {
  return (
    <article className="prose prose-neutral max-w-none space-y-4 text-body">
      ...
      <p>
        These Terms govern your use of Tended (&quot;Tended,&quot; &quot;we,&quot; or &quot;us&quot;), a website and
        platform operated by a 501(c)(3) nonprofit organization that coordinates virtual volunteer work for
        nonprofits and public agencies. By creating an account or using Tended, you agree to these Terms.
      </p>

      <h2 className="mt-8 text-xl font-semibold text-ink">1. What Tended is</h2>
      <p>
        Tended lets volunteers select and complete civic tasks posted by partner nonprofits and public agencies.
        For volunteers who receive SNAP/CalFresh, certified hours can be reflected on a pre-filled state work-hours
        form that the volunteer downloads and submits to their county. Tended is not a government agency, does not
      ...
      <p>
        Tended does not pay you for your work, and the partner organization that hosts a task does not pay you for
        it. You participate as a volunteer. Hours certified through Tended represent the actual measured time you
      ...
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>use Tended to violate any applicable law or the terms of any benefits program.</li>
      </ul>
      <p>
      ...
      <p>
        Tended is built on the principle that the work product is a public good. When you complete a task, you
        grant Tended and the hosting partner organization a worldwide, royalty-free, non-exclusive, perpetual
        ...
        <a href="/privacy" className="text-forest underline"> Privacy Policy</a> for details.
      </p>
      ...
      <p>
        ...
        any benefits requirement. Tended makes no guarantee about acceptance or eligibility.
      </p>

      <h2 className="mt-8 text-xl font-semibold text-ink">7. Third-party services</h2>
      <p>
        Tended uses third-party providers for authentication, hosting, file storage, AI-assisted review of
      ...
      <p>
        Tended is provided &quot;as is&quot; and &quot;as available,&quot; without warranties of any kind, express
      ...
      <p>
        To the fullest extent permitted by law, Tended and its directors, officers, employees, contractors, and
      ...
      <p>
        You may stop using Tended at any time and may delete your account from your settings. We may suspend or
...
function Es() {
  return (
    <article className="prose prose-neutral max-w-none space-y-4 text-body">
      ...
      <p>
        Estos Términos rigen tu uso de Tended (&quot;Tended,&quot; &quot;nosotros&quot;), un sitio web y plataforma
        operados por una organización sin fines de lucro 501(c)(3) que coordina trabajo voluntario virtual para
        organizaciones sin fines de lucro y agencias públicas. Al crear una cuenta o usar Tended, aceptas estos
        Términos.
      </p>

      <h2 className="mt-8 text-xl font-semibold text-ink">1. Qué es Tended</h2>
      <p>
        Tended permite a los voluntarios seleccionar y completar tareas cívicas publicadas por organizaciones
        socias. Para voluntarios que reciben SNAP/CalFresh, las horas certificadas pueden reflejarse en un
        formulario estatal pre-llenado que el voluntario descarga y envía a su condado. Tended no es una agencia
      ...
      <p>
        Tended no te paga por tu trabajo, y la organización socia que aloja una tarea tampoco te paga por ella.
      ...
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>usar Tended para violar cualquier ley aplicable o los términos de un programa de beneficios.</li>
      </ul>
      <p>
      ...
      <p>
        Tended se basa en el principio de que el producto del trabajo es un bien público. Al completar una tarea,
        otorgas a Tended y a la organización socia anfitriona una licencia mundial, libre de regalías, no
        ...
        la <a href="/privacy" className="text-forest underline">Política de privacidad</a> para más detalles.
      </p>
      ...
      <p>
        ...
        resultante se acepta para cualquier requisito de beneficios. Tended no garantiza la aceptación ni la
        elegibilidad.
      </p>

      <h2 className="mt-8 text-xl font-semibold text-ink">7. Servicios de terceros</h2>
      <p>
        Tended usa proveedores externos para autenticación, alojamiento, almacenamiento de archivos, revisión
      ...
      <p>
        Tended se proporciona &quot;tal cual&quot; y &quot;según disponibilidad,&quot; sin garantías de ningún
      ...
      <p>
        En la medida máxima permitida por la ley, Tended y sus directores, funcionarios, empleados, contratistas y
      ...
      <p>
        Puedes dejar de usar Tended en cualquier momento y eliminar tu cuenta desde la configuración. Podemos
