 ...
 * The free-text `notes` AND `zip_codes` columns (migration 0015 marks zip_codes
 * "free text — moderation status below gates publishing") publish only when
 * text_moderation_status = 'approved'. zip_codes was previously emitted
 * unconditionally; it is now gated to match.
 *
