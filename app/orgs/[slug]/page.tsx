        ...
        <div className="mx-auto max-w-[1200px] px-4 py-12 md:px-6 md:py-16">
          ...
          <div className="mt-10 grid gap-12 lg:grid-cols-[1fr_320px]">
            ...
            <div className="min-w-0 lg:order-2 lg:col-start-1">
              <h2 className="text-[22px] font-semibold text-ink">Open civic tasks</h2>
              {cards.length > 0 ? (
                ...
                <div className="mt-5">
                  <EmptyState
                    ...
                    body="This organization doesn't have any active tasks at the moment. Check back soon."
                  />
                </div>
              )}
            </div>
              ...
              <div className="rounded-lg border border-line bg-white p-5">
                ...
                <div className="mt-3">
                  {org.about_md ? (
                    ...
                    <p className="text-sm text-body">This organization hasn&apos;t added a description yet.</p>
                  )}
                </div>
              </div>
            </aside>
