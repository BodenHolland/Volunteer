      ...
      <div className="mx-auto max-w-[1200px] px-4 py-10 md:px-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-2 text-sm sm:grid-cols-3">
            ...
            <Link href="/data/hours-calculator" className="text-blue-100 hover:text-white">{t.nav.hoursCalculator}</Link>
            <Link href="/privacy" className="text-blue-100 hover:text-white">{t.footer.privacy}</Link>
            <Link href="/terms" className="text-blue-100 hover:text-white">{t.footer.terms}</Link>
