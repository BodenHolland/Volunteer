...
export type BasketItemCategory =
  | "dairy" | "eggs" | "bread" | "rice" | "beans" | "produce"
  | "protein" | "meat" | "frozen" | "pantry" | "beverage";
...
export const USDA_THRIFTY_6: BasketTemplateConfig = {
  ...
  items: [
    ...
    },
    {
      ...
      spec: "16 oz jar, creamy, store brand / generic",
      category: "protein",
      expected_size_range_min: 16,
      expected_size_range_max: 16,
      expected_size_unit: "oz",
      plausibility_band_usd_low: 2.0,
      plausibility_band_usd_high: 12.0,
      unit_options: ["oz"],
      size_capture: "fixed",
    },
...
export const EXTENDED_BASKET_CATALOG: BasketItem[] = [
  {
    id: "canned-black-beans",
    display_name: "Canned black beans",
    spec: "15 oz can, store brand / generic",
    category: "beans",
    expected_size_range_min: 15,
    expected_size_range_max: 15,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 0.5,
    plausibility_band_usd_high: 5.0,
    unit_options: ["oz"],
  ...
  },
  {
    ...
    spec: "5 oz can, light chunk in water, store brand",
    category: "protein",
    expected_size_range_min: 5,
    expected_size_range_max: 5,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 0.8,
    plausibility_band_usd_high: 6.0,
    unit_options: ["oz"],
    size_capture: "fixed",
  },
  {
    ...
    spec: "1 lb bag, any variety",
    category: "protein",
    expected_size_range_min: 1,
    expected_size_range_max: 1,
    expected_size_unit: "lb",
    plausibility_band_usd_low: 1.0,
    plausibility_band_usd_high: 7.0,
    unit_options: ["lb", "oz"],
    size_capture: "fixed",
  },
  {
    ...
    spec: "Bone-in, per lb (enter the per-lb shelf price)",
    category: "meat",
    expected_size_range_min: 0.1,
    expected_size_range_max: 10.0,
    expected_size_unit: "lb",
    plausibility_band_usd_low: 1.0,
    plausibility_band_usd_high: 12.0,
    unit_options: ["lb"],
  ...
  },
  {
    id: "butter",
    display_name: "Butter",
    spec: "1 lb (4 sticks), store brand",
    category: "dairy",
    expected_size_range_min: 1,
    expected_size_range_max: 1,
    expected_size_unit: "lb",
  ...
  {
    id: "shredded-cheddar",
    display_name: "Shredded cheddar",
    spec: "8 oz bag, store brand",
    category: "dairy",
    expected_size_range_min: 8,
    expected_size_range_max: 8,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 2.0,
    plausibility_band_usd_high: 10.0,
    unit_options: ["oz"],
  ...
  },
  {
    ...
    spec: "32 oz container, plain, store brand",
    category: "dairy",
    expected_size_range_min: 32,
    expected_size_range_max: 32,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 3.0,
    plausibility_band_usd_high: 12.0,
    unit_options: ["oz"],
    size_capture: "fixed",
  },
  ...
  },
  {
    ...
    spec: "3 lb bag",
    category: "produce",
    expected_size_range_min: 3,
    expected_size_range_max: 3,
    expected_size_unit: "lb",
    plausibility_band_usd_low: 1.5,
    plausibility_band_usd_high: 10.0,
    unit_options: ["lb"],
  ...
  {
    id: "frozen-spinach",
    display_name: "Frozen spinach",
    spec: "10–12 oz bag, store brand",
    category: "frozen",
    expected_size_range_min: 10,
    expected_size_range_max: 12,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 1.0,
    plausibility_band_usd_high: 6.0,
  ...
  },
  {
    id: "pasta",
    display_name: "Pasta",
    spec: "1 lb, spaghetti or rotini, store brand",
    category: "pantry",
    expected_size_range_min: 1,
    expected_size_range_max: 1,
    expected_size_unit: "lb",
  ...
  },
  {
    ...
    spec: "18 oz container, old-fashioned rolled oats, store brand",
    category: "pantry",
    expected_size_range_min: 18,
    expected_size_range_max: 18,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 2.0,
    plausibility_band_usd_high: 10.0,
    unit_options: ["oz"],
  ...
  },
  {
    ...
    spec: "48 oz bottle, store brand",
    category: "pantry",
    expected_size_range_min: 48,
    expected_size_range_max: 48,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 3.0,
    plausibility_band_usd_high: 15.0,
    unit_options: ["oz", "fl oz"],
    size_capture: "fixed",
  },
  {
    id: "canned-tomatoes",
    display_name: "Canned tomatoes",
    spec: "14.5 oz can, diced, store brand",
    category: "pantry",
    expected_size_range_min: 14.5,
    expected_size_range_max: 14.5,
    expected_size_unit: "oz",
    plausibility_band_usd_low: 0.8,
    plausibility_band_usd_high: 5.0,
    unit_options: ["oz"],
  ...
  },
  {
    ...
    spec: "4 lb bag, store brand",
    category: "pantry",
    expected_size_range_min: 4,
    expected_size_range_max: 4,
    expected_size_unit: "lb",
    plausibility_band_usd_low: 2.0,
    plausibility_band_usd_high: 12.0,
    unit_options: ["lb"],
  ...
  },
  {
    ...
    spec: "64 oz carton, from concentrate, store brand",
    category: "beverage",
    expected_size_range_min: 64,
    expected_size_range_max: 64,
    expected_size_unit: "fl oz",
    plausibility_band_usd_low: 2.0,
    plausibility_band_usd_high: 12.0,
    unit_options: ["fl oz", "oz"],
    size_capture: "fixed",
  },
  {
    id: "drinking-water",
    display_name: "Bottled water",
    spec: "1 gallon jug, store brand",
    category: "beverage",
    expected_size_range_min: 1,
    expected_size_range_max: 1,
    expected_size_unit: "gal",
  ...
  },
  {
    ...
    spec: "30 ct, 8-inch, store brand",
    category: "pantry",
    expected_size_range_min: 30,
    expected_size_range_max: 30,
    expected_size_unit: "count",
    plausibility_band_usd_low: 2.0,
    plausibility_band_usd_high: 10.0,
    unit_options: ["count"],
...
export const BASKET_CATEGORY_LABELS: Record<BasketItemCategory, string> = {
  dairy: "Dairy",
  eggs: "Eggs",
  bread: "Bread",
  rice: "Grains",
...
export function findItem(id: string): BasketItem | undefined {
  return USDA_THRIFTY_6.items.find((i) => i.id === id)
    ?? EXTENDED_BASKET_CATALOG.find((i) => i.id === id);
}
...
export function syncValidate(input: SubmitCheckInput): { ok: boolean; reason?: string; flags: PendingFlag[] } {
  ...
  const capturedIds = new Set(input.captures.map((c) => c.item_id));
  const missingRequired = USDA_THRIFTY_6.items.filter((i) => !capturedIds.has(i.id));
  if (missingRequired.length > 0) {
    return {
      ok: false,
      reason: `Required items not yet captured: ${missingRequired.map((i) => i.display_name).join(", ")}.`,
      flags,
    };
  }
