 ...
 * signal is available (callers treat null as "no evidence", not "near"). Used by
 * the proof-of-presence check: any signal placing the volunteer near the store
 * clears it, so a photo with no EXIF can still be validated against device GPS.
 */
